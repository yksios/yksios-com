        ...
        var settings = $.extend({
            cookieTypes: [
                ...
                // },
                {
                    type: 'Analíticas',
                    value: 'analytics',
                    description: 'Cookies relacionadas con las visitas, el típo de navegador, etc.'
                },
                // {
                //     type: 'Marketing',
                //     value: 'marketing',
            ...
            message: 'yksios.com utiliza cookies de terceros para optimizar tu navegación, adaptarse a tus preferencias y realizar labores de análisis.',
            link: 'cookies.html',
            delay: 1000,
            expires: 30,
            ...
            fixedCookieTypeDesc: 'Cookies necesarias para un funcionamiento correcto de la página.',
            onAccept: function () { },
            uncheckBoxes: false
        }, options);
